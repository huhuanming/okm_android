...
public class MenuAdapter extends BaseAdapter{
    ...
    public MenuAdapter(Context context,ArrayList<String> menuEntries,ArrayList<Integer> menuImage)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            convertView = LayoutInflater.from(context).inflate(R.layout.activity_menu_item, null);
